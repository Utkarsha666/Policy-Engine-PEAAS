    ...
    <body>
        ...
        <div class="registration-bg">
            <div class="container">
                ...
                <center>
                    <form class="form-signin wow fadeInUp" action="HighSecurityVerification" method="post">
                        <h2 class="form-signin-heading">Login Form</h2>
                        <div class="login-wrap">
                            <p>Enter Login Details</p>
                            <input type="hidden" name="email" value="<%=cid%>">
                            <input type="text" class="form-control" placeholder="Public Key:" name="public_key" required="required" autofocus="">
