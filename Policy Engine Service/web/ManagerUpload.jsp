            ...
            <div class="navbar navbar-default navbar-static-top container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="ManagerUpload.jsp">Upload File</a>

                        </li>
                        <li>
                            <a href="ManagerDownload.jsp">Download File</a>
            ...
            <div class="container">
                ...
                <form action="uploadFile" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="login-wrap">
                        ...
                        <br/><br/>
                        <input type="radio" name="security">Low Security
                        <input type="radio" name="security">Medium Security
                        <input type="radio" name="security">High Security
                        <br/><br/>        
