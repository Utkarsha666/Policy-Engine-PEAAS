    ...
    <body>
        ...
        <%
            ...
            if (session.getAttribute("fileName") != null) {
                ...
                System.out.println("jjjjjjjjjjjjjjjjjjjjjj=============================================="+fileName);
            }
        %>
        <!--breadcrumbs start-->
        ...
        <div class="registration-bg">
            <div class="container">
                ...
                <center>
                    <form class="form-signin wow fadeInUp" action="LowSecurityVerification" method="post">
                        <h2 class="form-signin-heading">Login Form</h2>
                        <div class="login-wrap">
                            <p>Enter Login Details</p>
                            <input type="hidden"  name="fileName" value="<%=fileName%>">
                            <input type="text" class="form-control" placeholder="User Name" name="email" required="required" autofocus="">
