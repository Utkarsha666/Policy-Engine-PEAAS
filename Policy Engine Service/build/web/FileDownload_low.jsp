    ...
    <body>
        ...
        <%
            ...
            if (session.getAttribute("fileData") != null) {
                fileData = session.getAttribute("fileData").toString();
            }
                ...
                <div class="login-wrap">
                    <table>
                        <tr><form action="./download" method="post">
                            <input type="hidden" name="fname" value="<%=fileData%>"/>
                            <td><%=fileName%></td><td><input type="submit" name="submit"  value="Download"/></td>
                        </form>
                        </tr>
