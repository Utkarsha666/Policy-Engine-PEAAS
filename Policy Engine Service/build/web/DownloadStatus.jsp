...
<!--                    <ul class="nav navbar-nav">
        ...
        <%
            ...
            if (session.getAttribute("DownloadFile") != null) {
                DownloadFile = session.getAttribute("DownloadFile").toString();
            }
        %>
        <!--breadcrumbs start-->
        ...
        <!--breadcrumbs end-->
        <h3 style="color: #00a65a;"><%=DownloadFile%></h3> <% session.removeAttribute("DownloadFile");%>
        ...
        <div class="registration-bg">
            <div class="container">
                ...
                <div class="login-wrap">
                    <form action="verifyFile" method="post"><table>
