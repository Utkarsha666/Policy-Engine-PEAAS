    ...
    <body>
        ...
        <div class="registration-bg">
            <div class="container">
                ...
                <form class="form-signin wow fadeInUp" action="Registration" method="post" onsubmit="return validation() ;">
                    <h2 class="form-signin-heading">Register now</h2>
                    <div class="login-wrap">
                        <p>Enter personal details</p>
                        <input type="text" class="form-control" placeholder="Full Name" required="required" name="name" autofocus="">
                        <input type="text" class="form-control" placeholder="Address" required="required" name="address" autofocus="">
